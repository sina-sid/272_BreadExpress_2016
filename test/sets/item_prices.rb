module Contexts
  module ItemPrices
    ...
    def create_muffin_prices
      # Old prices
      @choc_muffins_old_price = FactoryGirl.create(:item_price, item: @choc_muffins, price: 7.99, start_date: 3.years.ago.to_date, end_date: 1.year.ago.to_date)
      @plain_muffins.active = true
      @plain_muffins.save!
      @plain_muffins_old_price = FactoryGirl.create(:item_price, item: @plain_muffins, price: 5.99, start_date: 2.years.ago.to_date, end_date: 1.year.ago.to_date)
